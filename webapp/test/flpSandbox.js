		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#ordersprojectnorthwindordersproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ordersprojectnorthwindordersproject-display": {
								"semanticObject": "ordersprojectnorthwindordersproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ordersproject.northwindordersproject",
									"url": sap.ui.require.toUrl("ordersproject/northwindordersproject")
								}
							}
						}
					}
